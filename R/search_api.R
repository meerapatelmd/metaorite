...
search_api <-
        function(string) {
                ...
                output <- loadCacheSearchResponse(string = string)
                ...
                if (is.null(output)) {
                        ...
                        for (i in 1:length(search_type)) {
                                ...
                                if (!(is.null(SERVICE_TICKET))) {
                                        ...
                                        secretary::typewrite_error("ERROR: SERVICE_TICKET is null even after reseting TGT.")
                        ...
                        cacheSearchResponse(object = output,
                                            string = string)
                } 
                
                output %>%
                    dplyr::bind_rows(.id = "SEARCH_TYPE")
        }
