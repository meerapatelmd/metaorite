#' Query NCI metathesaurus for all exact phrase matches
#' @import mySeagull
#' @export

query_nci_exact_phrase <-
        function(nci_phrase, nci_code_cui_map_table = "nci_code_cui_map_201808") {
                ...
                sql_statement <- paste0("SELECT * FROM ", nci_code_cui_map_table, " WHERE nci_str1 = '", nci_phrase, "' OR nci_str2 = '", nci_phrase, "';")
